...
sudo apt-get  -y install lxc curl xz-utils mercurial git apt-get install -y python-dev python-setuptools libxml2-dev libxslt-dev libmysqlclient-dev  git-core redis-server
